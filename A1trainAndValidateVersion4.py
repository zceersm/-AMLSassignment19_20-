...
ram_model.add(Conv2D(16, (3, 3), activation='relu', padding='same', 
                    input_shape=(218,178,3))) #this convolution layer uses 16, (3 by 3) pixel filters that are applied to each part of the image, returning 16 arrays of activation values called feature maps that indicate where certain features are located in the image.
...
train_image_generator = Image_data_generator.flow_from_directory(
        '/Users/faymita29/Desktop/AMLS/AMLS_19-20_SN16015140/Datasets/A1/train',
        target_size=(218, 178),
        batch_size=10,
        class_mode='binary')
...
validation_image_generator = Image_data_generator.flow_from_directory(
        '/Users/faymita29/Desktop/AMLS/AMLS_19-20_SN16015140/Datasets/A1/validate',
        target_size=(218, 178),
        batch_size=10,
        class_mode='binary')
